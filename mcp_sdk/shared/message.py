...
class ClientMessageMetadata:
    ...
    def __post_init__(self) -> None:
        ...
        if (self.on_resumption_token_update is not None and 
                not callable(self.on_resumption_token_update)):
            raise MessageValidationError(
                "on_resumption_token_update must be callable"
            )
...
MessageMetadata: TypeAlias = Union[
    ClientMessageMetadata,
    ServerMessageMetadata,
    None
]
